            ...
            <div class="col-sm-12">
                <div class="card-body card-block">
                    <form action="insere_livro.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="qtdeExemplares" class=" form-control-label">Quantidade de exemplares</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <input type="text" id="paginas" name="qtdeExemplares" placeholder="Quantidade de Exemplares" class="form-control">
                            </div>
