...
<body>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="images/cleyton.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="index.php"><img src="images/cleyton.png" alt="Logo"></a>
            </div>
    ...
    <?php
        $consulta = "SELECT * FROM aluno ORDER BY ra";
    ...
    ?>   
        <td>
            <a href="form_atualiza_aluno.php?ra=<?php echo $linha['ra'];?>"
            class="btn btn-primary"> Atualizar</a>
            &nbsp; &nbsp;
            <a href="deleta_aluno.php?ra=<?php echo $linha['ra'];?>"
